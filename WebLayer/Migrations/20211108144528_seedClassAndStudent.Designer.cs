...
namespace WebLayer.Migrations
{
    ...
    [Migration("20211108144528_seedClassAndStudent")]
    partial class seedClassAndStudent
    {
            ...
            modelBuilder.Entity("DatabaseLayer.Entity.Student", b =>
                {
                    ...
                    b.Property<DateTime>("Birthday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATE")
                        .HasDefaultValue(new DateTime(2021, 11, 8, 21, 45, 28, 450, DateTimeKind.Local).AddTicks(6781));
